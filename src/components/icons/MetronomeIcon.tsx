...
export const MetronomeIcon: React.FC<MetronomeIconProps> = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Pendulum arm - positioned halfway down and to the left */}
      <line x1="12" y1="12" x2="9" y2="16" strokeWidth="2" />
      ...
      <line x1="10.8" y1="15" x2="11.5" y2="15" strokeWidth="0.8" opacity="0.5" />
      <line x1="11.2" y1="18" x2="12" y2="18" strokeWidth="0.8" opacity="0.5" />
    </svg>
  );
};
