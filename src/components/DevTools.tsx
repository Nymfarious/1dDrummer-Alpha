...
import { MoreVertical, Key, Settings, Zap, Brain, Plus, Minus, X, TestTube, Beaker, Eye, EyeOff, Check, Pin, PinOff } from 'lucide-react';
        ...
        <div className="flex items-center gap-2">
          ...
          {onPinToggle && (
            <Button
              ...
              size="icon"
              onClick={onPinToggle}
              title={isPinned ? "Unpin DevTools" : "Pin DevTools"}
            >
